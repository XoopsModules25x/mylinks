 ...
 *
 * @copyright ::  &copy; XOOPS Project (https://xoops.org)
...
function b_mylinks_random_show()
{
    ...
    $result = $xoopsDB->query(
        'SELECT l.lid, l.cid, l.title, l.url, l.logourl, l.status, l.date, l.hits, l.rating, l.votes, l.comments, t.description FROM ' . $xoopsDB->prefix('mylinks_links') . ' l, ' . $xoopsDB->prefix('mylinks_text') . ' t WHERE l.lid=t.lid AND status>0 ORDER BY RAND() LIMIT 0,1'
    );
    if ($result) {
