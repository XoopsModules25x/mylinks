...
<table style='width: 100%; margin: 1px; padding: 4px; border-width: 0;'>
    <tr>
        <td>
            <ul>
            ...
            <form action='submit.php' method='post'>
                <table style='width: 80%; margin: auto;'>
                    ...
                    <tr>
                        ...
                        <td class='even'>
                            <{if $notify_show}>
                            <input type='checkbox' name='notify' value='1'><{$lang_notify}>
                            <{/if}>
                        </td>
                    </tr>
                </table>
                <br>
                <div style='text-align: center;'><input type='submit' name='submit' class='button' value='<{$lang_submit}>'/>&nbsp;<input type='button' value='<{$lang_cancel}>'
