...
<br><br>
<{if $mylinksshowlogo}>
<div style='text-align: center;'><{$mylinkslogoimage}></div><br>
<{/if}>
...
<table class='outer'>
    <tr>
        <th style='text-align: center;'><{$ranking.title}> (<{$lang_sortby}>)</th>
        <th style='width: 8%; text-align: center;'>
            <a href="javascript:mltoggleEffect('<{$mylinks_imgurl}>/icons', 'resizemltop10block<{$smarty.foreach.mlloop.iteration}>', 'mlsizetop10image<{$smarty.foreach.mlloop.iteration}>')"><img
                    id='mlsizetop10image<{$smarty.foreach.mlloop.iteration}>' src='<{$mylinks_imgurl}>/icons/minimize.gif' alt='<{$lang_minimizeblock}>' title='<{$lang_minimizeblock}>'/></a>
        </th>
    </tr>
    <tr>
        <td colspan='2'>
            <div id="resizemltop10block<{$smarty.foreach.mlloop.iteration}>" style="display: block;">
                <table style='width: 100%;'>
                    ...
                    <tr>
                        ...
                        <td class="odd" style='text-align: center;'><{$link.hits}></td>
                        <td class="even" style='text-align: center;'><{$link.rating}></td>
...
<{else}>
<div style='font-weight: bold; font-size: larger; text-align: center; margin: 4em 0;'><{$smarty.const._MD_MYLINKS_NOTOP10}><{$lang_sortby}></div>
<{/if}>
