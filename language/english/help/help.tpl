<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/mylinks/admin/index.php"
           title="Back to the administration of MyLinks"> MyLinks
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of MyLinks">
        </a></h1>
    ...
    <a href="https://xoops.gitbook.io/xoops-operations-guide/" target="_blank">XOOPS Operations
        Manual</a>.<br><br>

    <h4 class="odd">TUTORIAL</h4><b>

    You can find a more detailed Tutorial
    <a href="https://xoops.org/files/XOOPS%20Documentation_%20Modules/New%20Documentation/XU-306_MyLinksTutorial.pdf/download">here</a><b>
