 ...
 */
class CategoryBaseHandler extends \XoopsPersistableObjectHandler
{
    /**
    ...
    {
        $mylinksDir = \basename(\dirname(__DIR__));
        parent::__construct($db, 'mylinks_cat', mb_strtolower($mylinksDir) . 'Category', 'cid');
    }
...
eval(
    'class ' . $mylinksDir . 'Category extends CategoryBase
        {
        }
