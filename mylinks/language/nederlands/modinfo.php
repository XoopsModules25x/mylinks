...
define("_MI_MYLINKS_SMNAME4","Recentst");
...
define('_MI_MYLINKS_TPLDESC_ATOM','ATOM Feed Sjabloon');
define('_MI_MYLINKS_TPLDESC_PDA','PDA Friendly Feed Sjabloon');
define('_MI_MYLINKS_TPLDESC_RSS','RSS Feed Sjabloon');
